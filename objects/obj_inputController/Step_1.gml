...
global.inputMouseLeftPressed	= mouse_check_button_pressed(mouseLeft);
global.inputMouseLeftHeld		= mouse_check_button(mouseLeft);
global.inputMouseLeftReleased	= mouse_check_button_released(mouseLeft);

global.inputMouseRightPressed	= mouse_check_button_pressed(mouseRight);
global.inputMouseRightHeld		= mouse_check_button(mouseRight);
global.inputMouseRightReleased	= mouse_check_button_released(mouseRight);
